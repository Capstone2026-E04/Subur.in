...
- `POST /api/recommendations/simulate` ada khusus agar engine ini bisa diuji dan divalidasi dengan input sembarang tanpa perlu device atau riwayat tersimpan yang nyata, yang juga menjadi sandaran unit test di `ai/__tests__`.
